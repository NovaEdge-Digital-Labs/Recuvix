...
exports.generateExportContent = generateExportContent;
function generateExportContent(options) {
...
function generateHtmlExport(options) {
...
function generateXmlExport(options) {
